...
keytool -genkeypair -alias client -keyalg RSA -keysize 2048 -dname "CN=Client,OU=Client,O=PlumStep,L=CDMX,S=MX,C=CDMX" -keypass changeme -keystore $CLIENT_KEYSTORE -storepass changeme
keytool -genkeypair -alias server -keyalg RSA -keysize 2048 -dname "CN=Server,OU=Server,O=PlumStep,L=CDMX,S=MX,C=CDMX" -keypass changeme -keystore $SERVER_KEYSTORE -storepass changeme
